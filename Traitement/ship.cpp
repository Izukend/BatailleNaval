...
void plateaux_1(){
    ...
    Ship torpilleur{"Torpilleur", 9, 8, 2};
   ...
   //Initialisation du porte_avions
    ...
    //Initialisation du torpilleur
    for (int i = 0; i < torpilleur.length; i++){
        plateau[torpilleur.colum -1][torpilleur.row + i -1] = '1';
    }
    //Initialisation contre_torpilleur_1
    for (int i = 0; i < contre_torpilleur_1.length; ++i) {
        plateau[contre_torpilleur_1.colum - 1][contre_torpilleur_1.row + i - 1] = '1';
    }
    //Initialisation contre_torpilleur_2
    for (int i = 0; i < contre_torpilleur_2.length; ++i) {
        plateau[contre_torpilleur_2.colum -1][contre_torpilleur_2.row +i -1] ='1';
    }
}
void plateaux_2(){
